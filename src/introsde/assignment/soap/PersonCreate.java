 ...
 *         &lt;element name="currentHealth" type="{http://soap.assignment.introsde/}measureCreate" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "personCreate", propOrder = {
    "birthdate",
    "currentHealth",
    "firstname",
    "lastname"
...
public class PersonCreate {
    ...
    protected List<MeasureCreate> currentHealth;
    ...
    public List<MeasureCreate> getCurrentHealth() {
        if (currentHealth == null) {
            currentHealth = new ArrayList<MeasureCreate>();
        }
